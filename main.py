...
async def approve_withdrawal(call: types.CallbackQuery):
    ...
    if success:
        ...
        await call.message.edit_text(call.message.text.replace("⏳ Yumicoin API orqali olmos yuborilmoqda...", "") + "\n\n✅ <b>TASDIQLANDI</b> (Olmos Yumicoin hisobiga o'tkazildi)")
        try:
        ...
        await call.message.edit_text(call.message.text.replace("⏳ Yumicoin API orqali olmos yuborilmoqda...", "") + f"\n\n❌ <b>API XATOLIK:</b> {api_msg}\n(Olmos balansga qaytarildi)")
